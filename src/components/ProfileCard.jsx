...
const ProfileCardComponent = ({
  ...
  const tiltEngine = useMemo(() => {
    ...
    const step = ts => {
      ...
      // Only keep the loop alive while settling toward the target.
      // (Previously `document.hasFocus()` kept a permanent RAF while the tab
      // was focused, burning a frame every 16ms even when the card was idle.)
